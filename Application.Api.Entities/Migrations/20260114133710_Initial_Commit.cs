    ...
    public partial class Initial_Commit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9391), "", true, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9392), "Civil Engineering" });

            migrationBuilder.InsertData(
                table: "City",
                columns: new[] { "CityId", "CreatedBy", "CreatedDate", "IsActive", "LastModifiedBy", "LastModifiedDate", "Name" },
                values: new object[] { 1, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9106), true, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9120), "Nanded" });

            migrationBuilder.InsertData(
                table: "Country",
                columns: new[] { "CountryId", "CreatedBy", "CreatedDate", "IsActive", "LastModifiedBy", "LastModifiedDate", "Name" },
                values: new object[] { 1, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9359), true, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9360), "India" });

            migrationBuilder.InsertData(
                table: "Subject",
                columns: new[] { "SubjectId", "BranchId", "CreatedBy", "CreatedDate", "Description", "ImageName", "IsActive", "LastModifiedBy", "LastModifiedDate", "Name" },
                values: new object[] { 1, 1, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9430), "", "", true, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9431), "Engineering Mechanics" });

            migrationBuilder.InsertData(
                table: "Chapter",
                columns: new[] { "ChapterId", "Content", "CreatedBy", "CreatedDate", "IsActive", "LastModifiedBy", "LastModifiedDate", "Order", "SubjectId", "Title" },
                values: new object[] { 1, "", 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9544), true, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9545), 1, 1, "Chapter-1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9573), "Lesson on Mechanics", true, 1, new DateTime(2026, 1, 14, 19, 7, 8, 757, DateTimeKind.Local).AddTicks(9574), 1, "Lesson-1" });
